...
for(let outerConter = 1; outerConter<=5; outerConter++){
    console.log(`outer counter = ${outerConter}`)
...
// when the funtion doubleNumber is called and the user didn't enter an argument, number as an argument, the program will ask the user to enter a number. The function will fully run when the user enters an argument. 
